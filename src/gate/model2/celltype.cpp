...
CELL_TYPE("xor",   XOR,   1,0,0,1,1,  0xffff, 1);
CELL_TYPE("nand",  NAND,  1,0,0,1,0,  0xffff, 1);
CELL_TYPE("nor",   NOR,   1,0,0,1,0,  0xffff, 1);
CELL_TYPE("xnor",  XNOR,  1,0,0,1,1,  0xffff, 1);
CELL_TYPE("maj",   MAJ,   1,0,0,1,0,  0xffff, 1);
