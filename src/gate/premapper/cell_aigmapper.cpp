...
using Link          = CellAigMapper::Link;
using LinkList      = CellAigMapper::LinkList;
using SubnetBuilder = CellAigMapper::SubnetBuilder;

Link CellAigMapper::mapAnd(const LinkList &links, bool &inv,
                           SubnetBuilder &builder) const {

  return builder.addCellTree(CellSymbol::AND, links, 2);
}

Link CellAigMapper::mapOr(const LinkList &links, bool &inv,
                          SubnetBuilder &builder) const {
...
Link CellAigMapper::mapXor(const LinkList &links, bool &inv,
                           SubnetBuilder &builder) const {
...
Link CellAigMapper::mapMaj(const LinkList &links, bool &inv,
                           SubnetBuilder &builder) const {
...
Link CellAigMapper::addMaj3(const LinkList &links, bool &inv,
                        SubnetBuilder &builder) const {
...
Link CellAigMapper::addMaj5(const LinkList &links, bool &inv,
                        SubnetBuilder &builder) const {
