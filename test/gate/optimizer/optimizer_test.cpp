...
//===----------------------------------------------------------------------===//
  ...
  TEST(OptimizerTest, findCone) {
    ...
    auto *cone = findConePrint("test/data/gate/optimizer/output/findCone1", &net, {g[2], g[4]}, g[5]);
  ...
  TEST(OptimizerTest, findCone2) {
    ...
    auto cone = findConePrint("test/data/gate/optimizer/output/findCone2", &net, {g[2], g[3], g[4], g[6], g[7]},g[14]);
  ...
  TEST(OptimizerTest, findCone3) {
    ...
    auto cone = findConePrint("test/data/gate/optimizer/output/findCone3", &net, {g[0], g[3], g[7]},g[8]);
  ...
  TEST(OptimizerTest, findConeExessiveCut) {
    ...
    auto cone = findConePrint("test/data/gate/optimizer/output/findConeExessiveCut", &net, {g[0], g[1], g[2], g[4]},g[5]);
    EXPECT_EQ(3, cone->nGates());
    EXPECT_EQ(2, cone->nSourceLinks());
    delete cone;
  }
  ...
  TEST(OptimizerTest, findConeTrivial) {
    ...
    auto cone = findConePrint("test/data/gate/optimizer/output/findConeTrivial", &net, {g[5]},g[5]);
