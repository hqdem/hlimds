...
using Link          = CellMigMapper::Link;
using LinkList      = CellMigMapper::LinkList;
using SubnetBuilder = CellMigMapper::SubnetBuilder;

Link CellMigMapper::mapAnd(const LinkList &links, bool &inv,
                           SubnetBuilder &builder) const {

  return addMajTree(CellSymbol::AND, links, builder);
}

Link CellMigMapper::mapOr(const LinkList &links, bool &inv,
                          SubnetBuilder &builder) const {

  return addMajTree(CellSymbol::OR, links, builder);
}

Link CellMigMapper::mapXor(const LinkList &links, bool &inv,
                           SubnetBuilder &builder) const {

  return addMajTree(CellSymbol::XOR, links, builder);
}

Link CellMigMapper::addMajTree(CellSymbol symbol, const LinkList &links,
                               SubnetBuilder &builder) const {
...
Link CellMigMapper::addMaj(CellSymbol symbol, const LinkList &links,
                           SubnetBuilder &builder) const {
...
Link CellMigMapper::addXor(const LinkList &links,
                           SubnetBuilder &builder) const {
...
Link CellMigMapper::mapMaj(const LinkList &links, bool &inv,
                           SubnetBuilder &builder) const {
...
Link CellMigMapper::addMaj5(const LinkList &links,
                            SubnetBuilder &builder) const {
